...
[![Socket Badge](https://socket.dev/api/badge/pypi/package/onnxtr/0.9.0?artifact_id=tar-gz)](https://socket.dev/pypi/package/onnxtr/overview/0.9.0/tar-gz)
[![Pypi](https://img.shields.io/badge/pypi-v0.9.0-blue.svg)](https://pypi.org/project/OnnxTR/)
...
Python 3.11 (or higher) and [pip](https://pip.pypa.io/en/stable/) are required to install OnnxTR.
